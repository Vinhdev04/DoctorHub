...
<html lang="en">
  <head>
    ...
    <meta
      property="og:title"
      content="DoctorHub - Đặt lịch khám và tư vấn sức khỏe"
    />
    <meta
    ...
    <link
      rel="icon"
      href="/assets/images/Logo/DoctorHub.png"
      type="image/x-icon"
    />
    ...
    <header class="header">
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
          <a
            class="navbar-brand navbar__link d-flex align-items-center"
            href="/index.html"
          >
            <img
              src="/assets/images/Logo/DoctorHub.png"
              alt="Logo"
              width="30"
              height="24"
              class="d-inline-block align-text-top img-fluid navbar__logo"
            />
            DoctorHub
          </a>
          <button
          ...
          >
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/pages/book.html">Đặt Lịch Khám</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/pages/consultation.html"
                  >Tư Vấn Sức Khỏe</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/pages/services.html">Dịch Vụ Y Tế</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/pages/test.html">Bài Test</a>
              </li>
              <!-- Search Form -->
    ...
    <footer class="bg-light pt-5 pb-3 border-top">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6 mb-4">
            ...
            <div class="d-flex align-items-center">
              <img
                data-src="/assets/images/Icon/20240706162441-0-BCT.png"
                alt="Chứng nhận 1"
                class="me-2 lazyload"
                style="height: 30px"
              />
              <img
                data-src="/assets/images/Icon/20240706162441-0-DMCA.png"
                alt="Chứng nhận 2"
                style="height: 30px"
                class="lazyload"
              />
            ...
            <div class="d-flex flex-wrap">
              <img
                data-src="/assets/images/Icon/20240706162440-0-COD.png"
                alt="COD"
                class="me-2 mb-2 lazyload"
                style="height: 30px"
              />
              <img
                data-src="/assets/images/Icon/20240706162441-0-Visa.png"
                alt="VISA"
                class="me-2 mb-2 lazyload"
                style="height: 30px"
              />
              <img
                data-src="/assets/images/Icon/20240706162441-0-MasterCard.png"
                alt="Mastercard"
                class="me-2 mb-2 lazyload"
                style="height: 30px"
              />
              <img
                data-src="/assets/images/Icon/20240706162441-0-JCB.png"
                alt="JCB"
                class="me-2 mb-2 lazyload"
                style="height: 30px"
              />
              <img
                data-src="/assets/images/Icon/20240706162441-0-Momo.png"
                alt="MoMo"
                class="me-2 mb-2 lazyload"
                style="height: 30px"
              />
              <img
                data-src="/assets/images/Icon/20240706162729-0-ZaloPay.png"
                alt="ZaloPay"
                class="me-2 mb-2 lazyload"
                style="height: 30px"
              />
              <img
                data-src="/assets/images/Icon/20241122062454-0-napas.png"
                alt="Napas"
                class="me-2 mb-2 lazyload"
                style="height: 30px"
              />
              <img
                data-src="/assets/images/Icon/20241122063240-0-apple-pay.png"
                alt="Apple Pay"
                class="me-2 mb-2 lazyload"
                style="height: 30px"
              />
        ...
        <div class="text-center border-top pt-3 mt-3 small text-muted">
          ...
          <a
            href="https://www.instagram.com/viinhneee/"
  ...
  <script
    ...
    integrity="sha384-JGLZOLoMCs5hQdIb2Rlp+vgbp7NjPR8tW3mv4TqRfj7sG04O1LYljX29lvH9acX7"
    crossorigin="anonymous"
  ></script>
  <!-- *Bootstrap* -->
  <script
